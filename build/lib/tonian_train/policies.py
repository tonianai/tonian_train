...
from tonian_train.networks import A2CBaseNet, A2CSequentialNetLogStd, build_A2CSequientialNetLogStd, A2CSharedNetLogStd, build_A2CSharedNetLogStd
...
def build_A2CSharedLogStdPolicy(config: Dict,
                                  obs_space: MultiSpace, 
                                  action_space: gym.spaces.Space):
    
    network = build_A2CSharedNetLogStd(config, obs_space, action_space)
